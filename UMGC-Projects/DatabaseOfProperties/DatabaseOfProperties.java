/*
Filename: DatabaseOfProperties.java
Author: Dmitry Landy
Date: July 14, 2020
...
*/
public class DatabaseOfProperties {
    /*
    ...
    public static class ProgramCore{
        ...
        */
        public static void main(String[] args) throws IOException {
            ...
            try{
                BufferedReader myReader = new BufferedReader(new FileReader("Properties.txt"));
                String read;
...
}//end class DatabaseOfProperties
